<a href="/public/admin" class="top-link" style="display: inline-block; margin-bottom: 15px; text-decoration: none; color: #2563eb;">← Volver al panel</a>
...
<form action="/public/admin/update" method="POST" style="max-width:680px; background: #fff; padding: 20px; border-radius: 8px;">
